...
func encodePkcs8ShroudedKeyBag(algorithm pkix.AlgorithmIdentifier, privateKey interface{}, password []byte) (asn1Data []byte, err error) {
	var pkData []byte
	if pkData, err = x509.MarshalPKCS8PrivateKey(privateKey); err != nil {
		return nil, errors.New("pkcs12: error marshaling private key: " + err.Error())
	}

	pkinfo := encryptedPrivateKeyInfo{
		AlgorithmIdentifier: algorithm,
	}
	if pkinfo.EncryptedData, err = pbEncrypt(algorithm, pkData, password); err != nil {
